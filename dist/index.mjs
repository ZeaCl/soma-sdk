...
function SomaChat({
  ...
  const defaultMessage = (msg) => {
    ...
    return /* @__PURE__ */ jsxs("div", { className: "soma-msg", style: css({ display: "flex", flexDirection: "column", alignItems: msg.role === "user" ? "flex-end" : "flex-start", gap: 4 }), children: [
      msg.thinking && /* @__PURE__ */ jsxs("div", { className: "soma-thinking-persisted", style: css({ maxWidth: "85%", borderRadius: c.radius, overflow: "hidden" }), children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "soma-bubble", style: css({
        maxWidth: "85%",
        padding: "10px 14px",
      ...
      }), children: /* @__PURE__ */ jsx("div", { className: "soma-md", dangerouslySetInnerHTML: { __html: renderMarkdown(msg.content) } }) })
    ] }, msg.id);
  };
  const defaultInput = /* @__PURE__ */ jsx("div", { className: "soma-input-area", style: css({ padding: "12px 16px", borderTop: `1px solid ${c.inputBorder}`, flexShrink: 0 }), children: /* @__PURE__ */ jsxs("div", { className: "soma-input-row", style: css({
    display: "flex",
    alignItems: "flex-end",
    gap: 8,
    ...
    isStreaming ? /* @__PURE__ */ jsx("button", { onClick: handleCancel, disabled: cancelling, className: "soma-btn-cancel", style: css({
      width: 32,
      height: 32,
      borderRadius: "50%",
      border: "none",
      ...
      fontSize: 14,
      flexShrink: 0
    }), children: cancelling ? "\u23F3" : "\u25A0" }) : /* @__PURE__ */ jsx("button", { onClick: handleSend, className: "soma-btn-send", style: css({
      width: 32,
      height: 32,
      borderRadius: "50%",
      border: "none",
  ...
  return /* @__PURE__ */ jsxs("div", { className: `soma-root ${className}`, style: css({ display: "flex", flexDirection: "column", height: "100%", background: c.bg, fontFamily: c.font }), children: [
    /* @__PURE__ */ jsxs("div", { ref: feedRef, className: "soma-feed", style: css({ flex: 1, overflowY: "auto", padding: "16px", display: "flex", flexDirection: "column", gap: 12 }), children: [
      messages.length === 0 && !isStreaming && /* @__PURE__ */ jsx("p", { className: "soma-welcome", style: css({ textAlign: "center", fontSize: 13, color: c.textMuted, marginTop: "40%" }), children: welcomeMessage }),
      ...
      isStreaming && streamBlocks.length === 0 && /* @__PURE__ */ jsxs("div", { className: "soma-thinking-indicator", style: css({ display: "flex", alignItems: "center", gap: 8, padding: "8px 0" }), children: [
        /* @__PURE__ */ jsx("div", { style: css({ width: 6, height: 6, borderRadius: "50%", background: c.thinkingText, animation: "soma-pulse 1.2s ease-in-out infinite" }) }),
...
function StreamingView({ blocks, colors: c, thinkingOpen, onToggleThinking }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "soma-stream", style: css({ display: "flex", flexDirection: "column", gap: 8 }), children: [
    hasThinking && /* @__PURE__ */ jsxs("div", { className: "soma-thinking", style: css({ borderRadius: c.radius, overflow: "hidden" }), children: [
      /* @__PURE__ */ jsxs("button", { onClick: onToggleThinking, className: "soma-thinking-toggle", style: css({
        display: "flex",
        alignItems: "center",
        gap: 6,
        width: "100%",
      ...
      thinkingOpen && /* @__PURE__ */ jsx("div", { className: "soma-thinking-body", style: css({
        padding: "8px 12px",
        background: c.thinkingBg,
        borderLeft: `2px solid ${c.thinkingBorder}`,
        fontSize: 12,
    ...
    blocks.filter((b) => b.type === "tool_call").map((b, i) => /* @__PURE__ */ jsxs("div", { className: "soma-tool", style: css({
      display: "flex",
      alignItems: "center",
      gap: 8,
      padding: "6px 12px",
    ...
    blocks.filter((b) => b.type === "tool_result").map((b, i) => /* @__PURE__ */ jsx("div", { className: "soma-result", style: css({
      padding: "8px 12px",
      borderRadius: 8,
    ...
    lastText && /* @__PURE__ */ jsx("div", { className: "soma-bubble soma-stream-text", style: css({
      padding: "10px 14px",
      borderRadius: c.radius,
    ...
    }), children: /* @__PURE__ */ jsx("div", { className: "soma-md", dangerouslySetInnerHTML: { __html: renderMarkdown(lastText) } }) })
  ] });
}
    ...
    /* @__PURE__ */ jsxs(
      "aside",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(SomaChat, { agentId, apiKey, baseUrl })
        ]
      }
    )
  ] });
...
function SortedFileTable({
  ...
  return /* @__PURE__ */ jsxs("table", { style: { width: "100%", borderCollapse: "collapse", fontSize: 13 }, children: [
    /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { style: { borderBottom: `1px solid ${c.border}` }, children: [
      ...
      onDelete && /* @__PURE__ */ jsx("th", { style: { padding: "6px 6px", width: 36 } })
    ] }) }),
    /* @__PURE__ */ jsx("tbody", { children: sorted.map((f, i) => /* @__PURE__ */ jsxs(
      "tr",
      {
        ...
        children: [
          ...
          onDelete && /* @__PURE__ */ jsx("td", { style: { padding: "6px 6px", textAlign: "center" }, children: confirmDelete === f.name ? /* @__PURE__ */ jsxs("span", { style: { display: "flex", gap: 4, justifyContent: "center" }, children: [
            /* @__PURE__ */ jsx(
              "button",
              {
                onClick: (e) => {
...
export { AgentSkillPanel, SkillManager, SomaChat, SomaConversationList, SomaCopilot, SomaFileBrowser, SomaFileViewer, SomaPanel, SomaSkillEditor, UserFileDropZone, UserWorkspace, createMemorySandboxProvider, createRestSandboxProvider, useSoma, useSomaAgents, useSomaConversations, useSomaFileContent, useSomaFiles, useSomaSkills, useUserWorkspace };
